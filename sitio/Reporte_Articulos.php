  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Reporte Articulos</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                        <?php while($fila_query_HYD_PRODUCTO = $query_HYD_PRODUCTO->fetch_assoc()){ ?>
                            <tr>
                              <td><?php echo $fila_query_HYD_PRODUCTO['PRD_Producto'];?></td>
                              <td><?php echo $fila_query_HYD_PRODUCTO['PRD_Descripcion'];?></td>
